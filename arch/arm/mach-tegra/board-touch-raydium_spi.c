				...
				int asize)
{
	...
	rm31080ts_data->gpio_1v8 = TEGRA_GPIO_PH4;
	gpio_request(rm31080ts_data->gpio_1v8, "TS_1V8_EN");

	rm31080ts_data->gpio_3v3 = TEGRA_GPIO_PH0;
	gpio_request(rm31080ts_data->gpio_3v3, "TP_PWR_EN");
