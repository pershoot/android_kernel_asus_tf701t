...
static __initdata struct tegra_pingroup_config macallan_pinmux_common[] = {
	...
	/*MEMORY_BOOSTRAP_PIN*/
	DEFAULT_PINMUX(GMI_AD4,       RSVD3,        NORMAL,    NORMAL,   INPUT),
	...
	GPIO_PINMUX(KB_COL0, PULL_UP, TRISTATE, INPUT, DISABLE),
	...
	GPIO_PINMUX(KB_ROW1, PULL_UP, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW2, PULL_UP, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW3, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW4, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW5, PULL_UP, TRISTATE, INPUT, DISABLE),
...
static __initdata struct tegra_pingroup_config macallan_pinmux_hw_rev_e[] = {
	...
	/* PAD EC_REQUEST */
	DEFAULT_PINMUX(KB_COL2,       KBC,         PULL_UP,   NORMAL,     OUTPUT),
	/* EC PS2_INT# */
	DEFAULT_PINMUX(GPIO_W2_AUD,   SPI6,        PULL_UP,   NORMAL,     INPUT),
	/* EC KB_INT# */
	DEFAULT_PINMUX(GMI_CS0_N,   RSVD0,         PULL_UP,   NORMAL,     INPUT),
	/* HALL SENSOR, LID# */
...
static __initdata struct tegra_pingroup_config macallan_pinmux_haydn_hw_rev_a[] = {
	...
	/*scalar staus*/
	GPIO_PINMUX(GMI_AD11,         PULL_UP,     TRISTATE,  INPUT,      DISABLE),
};
...
static __initdata struct tegra_pingroup_config asustek_pcbid_pins[] = {
	GPIO_PINMUX(GMI_AD15, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD14, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(GMI_DQS_P, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(GMI_A18, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD13, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(GMI_CS2_N, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(GMI_WP_N, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(ULPI_DATA1, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(ULPI_DATA5, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(DAP3_FS, NORMAL, TRISTATE, INPUT, DISABLE),
	GPIO_PINMUX(DAP3_SCLK, NORMAL, TRISTATE, INPUT, DISABLE),
};
...
static struct gpio_init_pin_info init_gpio_mode_macallan_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PP0, true, 0),//PCB_ID9
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PP3, true, 0),//PCB_ID10
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH5, true, 0),//PCB_ID4
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH6, true, 0),//PCB_ID1
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PK3, true, 0),//PCB_ID5
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PJ3, true, 0),//PCB_ID2
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PC7, true, 0),//PCB_ID6
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH7, true, 0),//PCB_ID0
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PB1, true, 0),//PCB_ID3
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO2, true, 0),//PCB_ID7
...
static struct gpio_init_pin_info init_gpio_mode_macallan_hw_rev_e[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO0, true, 0),//DOCK_IN#
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PW2, true, 0),//PS2_INT#
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PJ0, true, 0),//KB_INT DOCK_DET#
...
static struct gpio_init_pin_info init_gpio_mode_macallan_haydn_hw_rev_a[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PQ2, false, 0),//PAD EC_REQUEST#_1V8
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO0, true, 0),//DOCK_IN#
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH3, true, 0),//scalar_status
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PI3, false, 0),//splashtop
};
