...
static int mem_bootstrap_ad4 = 0, mem_bootstrap_ad5 = 0;
struct kobject *mem_brand_kobj;

static int show_mem_brand(struct device *dev, struct device_attribute *attr, char *buf);
static DEVICE_ATTR(mem_brand, S_IWUSR | S_IRUGO, show_mem_brand, NULL);

static struct attribute *mem_brand_attributes[] = {
	&dev_attr_mem_brand.attr,
	NULL
};

static const struct attribute_group mem_brand_group = {
	.attrs = mem_brand_attributes,
};
...
static int show_mem_brand(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	if(machine_is_mozart() && (hw_version == HW_REV_C || hw_version == HW_REV_B || hw_version == HW_REV_G))
	{
	...
	else if(machine_is_haydn() && (hw_version == HW_REV_A || hw_version == HW_REV_E || hw_version == HW_REV_C || hw_version == HW_REV_G))
	{
		if(mem_bootstrap_ad4 == 0 && mem_bootstrap_ad5 == 0)
		{
			return sprintf(buf, "%s\n", "Hynix");
...
static int mem_brand_sysfs_init(void)
{
	int ret = 0;

	mem_brand_kobj = kobject_create_and_add("mem_info", NULL);

	ret = sysfs_create_group(mem_brand_kobj, &mem_brand_group);

	return ret;
}

static struct tegra11_emc_table mozart_hw_rev_e_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
	...
	},
	{
		...
		},
		{
			...
			0x00249249, /* EMC_XM2DQSPADCTRL4 */
			0x20820800, /* EMC_XM2DQSPADCTRL3 */
			0x007fc009, /* EMC_DLL_XFORM_DQ0 */
			0xa0f10f0f, /* EMC_AUTO_CAL_CONFIG */
			0x00000000, /* EMC_DLL_XFORM_ADDR0 */
			0x00001010, /* EMC_XM2CLKPADCTRL2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x00000000, /* EMC_DLL_XFORM_ADDR2 */
	...
	},
	{
		...
		},
		{
			...
			0x00000000, /* EMC_DLL_XFORM_ADDR2 */
			0x0000000a, /* EMC_DLL_XFORM_DQS1 */
			0x00004009, /* EMC_DLL_XFORM_DQS2 */
			0x0000000a, /* EMC_DLL_XFORM_DQS3 */
			0x0000400b, /* EMC_DLL_XFORM_DQ1 */
...
static struct tegra11_emc_table mozart_hw_rev_c_elpida_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
...
static struct tegra11_emc_table mozart_hw_rev_g_b_elpida_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_table mozart_hw_rev_c_hynix_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_table mozart_hw_rev_g_b_hynix_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_table haydn_hw_rev_a_hynix_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_table haydn_hw_rev_a_elpida_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_pdata mozart_hw_rev_e_pdata = {
	.description = "mozart_hw_rev_e",
	.tables = mozart_hw_rev_e_table,
	.num_tables = ARRAY_SIZE(mozart_hw_rev_e_table),
};

static struct tegra11_emc_pdata mozart_hw_rev_c_elpida_pdata = {
	.description = "mozart_hw_rev_c_elpida 0729",
	.tables = mozart_hw_rev_c_elpida_table,
	.num_tables = ARRAY_SIZE(mozart_hw_rev_c_elpida_table),
};

static struct tegra11_emc_pdata mozart_hw_rev_g_b_elpida_pdata = {
	.description = "mozart_hw_rev_g_b_elpida 0829",
	.tables = mozart_hw_rev_g_b_elpida_table,
	.num_tables = ARRAY_SIZE(mozart_hw_rev_g_b_elpida_table),
};

static struct tegra11_emc_pdata mozart_hw_rev_c_hynix_pdata = {
	.description = "mozart_hw_rev_c_hynix 0729",
	.tables = mozart_hw_rev_c_hynix_table,
	.num_tables = ARRAY_SIZE(mozart_hw_rev_c_hynix_table),
};

static struct tegra11_emc_pdata mozart_hw_rev_g_b_hynix_pdata = {
	.description = "mozart_hw_rev_g_b_hynix 0729",
	.tables = mozart_hw_rev_g_b_hynix_table,
	.num_tables = ARRAY_SIZE(mozart_hw_rev_g_b_hynix_table),
};

static struct tegra11_emc_pdata haydn_hw_rev_a_hynix_pdata = {
	.description = "haydn_hw_rev_a_hynix_table 0815",
	.tables = haydn_hw_rev_a_hynix_table,
...
static struct tegra11_emc_pdata haydn_hw_rev_a_elpida_pdata = {
	.description = "haydn_hw_rev_a_elpida_table 0830",
	.tables = haydn_hw_rev_a_elpida_table,
...
static struct tegra11_emc_pdata *macallan_get_emc_data(void)
{
	...
	if(machine_is_mozart())
	{
		...
		{
			case HW_REV_E:
				printk("%s : use %s table.\n", __func__, mozart_hw_rev_e_pdata.description);
				return &mozart_hw_rev_e_pdata;
				break;

			case HW_REV_C:
				if(mem_bootstrap_ad4 == 0 && mem_bootstrap_ad5 == 0)
				{
					printk("%s : use %s table.\n", __func__, mozart_hw_rev_c_hynix_pdata.description);
					return &mozart_hw_rev_c_hynix_pdata;
				}
				else if(mem_bootstrap_ad4 == 1 && mem_bootstrap_ad5 == 0)
				{
					printk("%s : use %s table.\n", __func__, mozart_hw_rev_c_elpida_pdata.description);
					return &mozart_hw_rev_c_elpida_pdata;
				}
				else
				{
					printk("error bootstrap pin value mem_bootstrap_ad4 = %d, mem_bootstrap_ad5 = %d\n", mem_bootstrap_ad4, mem_bootstrap_ad5);
					return NULL;
				}
				break;
			...
			case HW_REV_G:
				if(mem_bootstrap_ad4 == 0 && mem_bootstrap_ad5 == 0)
				{
					printk("%s : use %s table.\n", __func__, mozart_hw_rev_g_b_hynix_pdata.description);
					return &mozart_hw_rev_g_b_hynix_pdata;
				}
				else if(mem_bootstrap_ad4 == 1 && mem_bootstrap_ad5 == 0)
				{
					printk("%s : use %s table.\n", __func__, mozart_hw_rev_g_b_elpida_pdata.description);
					return &mozart_hw_rev_g_b_elpida_pdata;
				}
				else
				{
					printk("error bootstrap pin value mem_bootstrap_ad4 = %d, mem_bootstrap_ad5 = %d\n", mem_bootstrap_ad4, mem_bootstrap_ad5);
	...
	else if(machine_is_haydn())
	{
		...
		switch(hw_version)
		{
			...
			case HW_REV_E:
				if(mem_bootstrap_ad4 == 0 && mem_bootstrap_ad5 == 0)
				{
					printk("%s : use %s table.\n", __func__, haydn_hw_rev_a_hynix_pdata.description);
					return &haydn_hw_rev_a_hynix_pdata;
				}
				else if(mem_bootstrap_ad4 == 1 && mem_bootstrap_ad5 == 0)
				{
					printk("%s : use %s table.\n", __func__, haydn_hw_rev_a_elpida_pdata.description);
					return &haydn_hw_rev_a_elpida_pdata;
				}
				else
				{
					printk("error bootstrap pin value mem_bootstrap_ad4 = %d, mem_bootstrap_ad5 = %d\n", mem_bootstrap_ad4, mem_bootstrap_ad5);
...
int __init macallan_emc_init(void)
{
	...
	if(machine_is_mozart() || machine_is_haydn())
	{
		if(machine_is_mozart())
		{
			printk("it's mozart\n");
			switch(hw_version)
			{
				...
				case HW_REV_G:
					...
					break;
				case HW_REV_B:
					printk("%s : it's HW_REV_B.\n", __func__);
					break;

				default:
					printk("%s disable emc DVFS.\n", __func__);
					/* dummy return for bring-up */
					return 0;
					break;
			}
		}
		...
		{
			printk("it's haydn HW version = %d\n", hw_version);
			switch(hw_version)
			{
				case HW_REV_A:
					printk("%s : it's HW_REV_A.\n", __func__);
					break;
				case HW_REV_E:
					printk("%s : it's HW_REV_E.\n", __func__);
					break;
	...
	{
		printk("Invaild project_id disable EMC DVFS\n");
	}

	mem_brand_sysfs_init();
