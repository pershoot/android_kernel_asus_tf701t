...
static struct regulator_consumer_supply palmas_ldo5_e1569_supply[] = {
	...
	REGULATOR_SUPPLY("avdd_cam_sub", NULL),
};
...
PALMAS_REGS_PDATA(smps6, 0, 0, NULL, 0, 0, 0, 0,
	0, 0, 0, 0, 0);
...
PALMAS_REGS_PDATA(smps9, 2900,  2900, NULL, 1, 0, 1, NORMAL,
	0, 0, 0, 0, 0);
PALMAS_REGS_PDATA(smps10, 0,  0, NULL, 0, 0, 0, 0,
	0, 0, 0, 0, 0);
...
static struct regulator_consumer_supply fixed_reg_vd_cam_1v8_supply[] = {
	...
	REGULATOR_SUPPLY("vddio_cam_sub", NULL),
	REGULATOR_SUPPLY("vddio_cam", "vi"),
};

static struct regulator_consumer_supply fixed_reg_vd_xusb_1v2_supply[] = {
	REGULATOR_SUPPLY("avddio_usb", "tegra-xhci"),
	REGULATOR_SUPPLY("avdd_usb_pll", "tegra-xhci"),
};

static struct regulator_consumer_supply fixed_reg_vd_xusb_3v3_supply[] = {
...
FIXED_REG(7,	vd_xusb_1v2,	vd_xusb_1v2,
	NULL,	0,	0,
	PALMAS_TEGRA_GPIO_BASE + PALMAS_GPIO3,	true,	true,	0,	1200);

FIXED_REG(8,	vd_xusb_3v3,	vd_xusb_3v3,
	NULL,	0,	0,
...
static struct platform_device *fixed_reg_devs[] = {
	...
	ADD_FIXED_REG(vd_xusb_1v2),
	ADD_FIXED_REG(vd_xusb_3v3),
};
